...
public record OwnerGymEquipmentDto(Long id, String name, String type, String category, String imageUrl, String status, Integer gridX, Integer gridY, Integer spanW, Integer spanH) {
